...
from razer_daemon.keyboard import KEY_MAPPING, TARTARUS_KEY_MAPPING, EVENT_MAPPING, TARTARUS_EVENT_MAPPING, NAGA_HEX_V2_EVENT_MAPPING, NAGA_HEX_V2_KEY_MAPPING, ORBWEAVER_EVENT_MAPPING, ORBWEAVER_KEY_MAPPING, NOSTROMO_EVENT_MAPPING, NOSTROMO_KEY_MAPPING
...
class NostromoKeyManager(GamepadKeyManager):
    GAMEPAD_EVENT_MAPPING = NOSTROMO_EVENT_MAPPING
    GAMEPAD_KEY_MAPPING = NOSTROMO_KEY_MAPPING
